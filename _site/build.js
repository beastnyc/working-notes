...
const NOTE_CSS = String.raw`
        ...
        :root {
            ...
            --panel-gap: 16px;
            --panel-radius: 18px;
            --panel-current-width: clamp(32rem, 50vw, 42rem);
            --panel-previous-width: clamp(22rem, 34vw, 28rem);
        ...
        * {
        ...
        .note-panel {
            ...
            transition: width 0.35s cubic-bezier(0.19, 1, 0.22, 1), transform 0.35s ease, box-shadow 0.35s ease;
        ...
        .note-content {
            padding: 56px clamp(32px, 4vw, 68px) 48px clamp(32px, 4vw, 48px);
            max-width: 100%;
            position: relative;
        }
